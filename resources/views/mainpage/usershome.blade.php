        ...
        <div class="col-4 mt-4 p-3">
            <div class="d-flex align-items-center p-2">
                <div>
                    ...
                    foreach ($getusers as $get) {
                        ...
                        //    echo "<img src='/storage/".{{Auth::user()->profile_pic}}'  height='30' class='rounded-circle border'>";
                           echo '<img src="/storage/'.$get->profile_pic.'" alt="" height="60" class="rounded-circle border">';
                        }
                    }
                @endphp
                </div>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                   ...
                   <a href="/mainprofile/{{$get->username}}" class="text-decoration-none text-dark"> <h6 style="margin: 0px;">{{$get->first_name}} {{$get->last_name}}</h6> </a> 
                    <p style="margin:0px;" class="text-muted"><span>@</span>{{$get->username}}</p>
                    @endforeach
                </div>
            </div>
            <div>
